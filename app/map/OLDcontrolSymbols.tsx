...
function initSymbolsPart<T>(symbolsPartObject: { id: string, content: any }, predicate: (content: any) => content is T):
  symbolsPartObject is { id: string, content: T } {
  return predicate(symbolsPartObject.content);
}
...
export default function ControlSymbolsPage() {
  ...
  const renderMethod = {
    course_title: (object: any) =>
      initSymbolsPart(object, isContentForCourseTitle) ? renderCourseTitle(object.content) : null,
    route_info: (object: any) =>
      initSymbolsPart(object, isContentForRouteInfo) ? renderRouteInfo(object.content) : null,
    controls: (object: any) =>
      initSymbolsPart(object, isContentForControls) ? renderControls(setShowModal, setChosenControl, setChosenKind, object.content, currentRoute) : null,
    finish: (object: any) =>
      initSymbolsPart(object, isContentForFinish) ? renderFinish(object.content) : null,
  };
